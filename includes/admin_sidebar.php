...
<div class="flex h-screen overflow-hidden bg-gray-50 font-sans">
    ...
    <aside class="w-64 bg-slate-900 text-sm text-slate-300 flex-shrink-0 hidden md:flex flex-col shadow-2xl z-20 border-r border-slate-800">
        ...
        <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto sidebar-scroll">
            ...
            <div class="pt-6 pb-2 px-3 text-[10px] font-bold text-slate-500 uppercase tracking-widest">Applications</div>
            ...
            <div class="pt-6 pb-2 px-3 text-[10px] font-bold text-slate-500 uppercase tracking-widest">Setup & Configuration</div>
            ...
            <?php if (in_array($admin_role, ['Super Admin', 'Academic Staff'])): ?>
            <!-- System section -->
            <div class="pt-6 pb-2 px-3 text-[10px] font-bold text-slate-500 uppercase tracking-widest">System</div>
            ...
            <div class="pt-6 pb-2 px-3 text-[10px] font-bold text-slate-500 uppercase tracking-widest">Analytics & Staff</div>
    ...
    <main class="flex-1 flex flex-col min-w-0 overflow-hidden bg-[#f8fafc]">
        ...
        <!-- Top Navbar -->
        <header class="h-14 bg-white border-b border-gray-100 shadow-sm flex items-center justify-between px-5 shrink-0 z-10">
            <!-- Left: page breadcrumb / school name on mobile -->
